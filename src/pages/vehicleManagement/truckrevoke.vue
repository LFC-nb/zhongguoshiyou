  ...
  <div class="hdp-uf hdp-uf-dc hdp-w-100">
    <div class="hdp-uf hdp-w-100 hdp-uf-dc" style="background:#FFFFFF;padding:10px">
      <div class="hdp-uf" style="margin-top:15px;display: inline-block;">
        ...
        <div class="hdp-uf" style="margin:0 15px 5px 0;display: inline-block;">
          <el-button @click="gettruckApplycancel" size="small" type="primarydel">查询</el-button>
        </div>
        <div class="hdp-uf" style="margin:0 15px 5px 0;display: inline-block;">
...
export default {
  ...
  methods: {
    async init() {
      ...
      this.gettruckApplycancel()
      this.assemblelinks()
    },
    async gettruckApplycancel() {
      ...
      let resData = await truckapplyApi.getApplylistcancel(conditionsParams)
    ...
    assemblelinks() {
      this.reportfile = this.filepdf + 'ImportExcel.aspx?action=apply&CarType=' + this.CarType + '&QueryStatus=2&StartTime=' + this.datepickervalue[0] + '&EndTime=' + this.datepickervalue[1] + '&DepartmentLev=' + this.search.DepartmentLev
    },
